<?php
	...
	function dictRet($keyStr, $arr = NULL){
		...
		$words = array (
			...
			"Score winner" 						=> array($arr[0] . "-" . $arr[1] . " score: " . $arr[2] . "-" . $arr[3] . ". Winner: " . $arr[4],			$arr[0] . "-" . $arr[1] . " 得分: " . $arr[2] . "-" . $arr[3] . ". 胜者: " . $arr[4]),
			"Surrender winner" 				=> array($arr[0] . " surrendered. Winner: " . $arr[1],		$arr[0] . " 投降. 胜者: " . $arr[1]),
